...
namespace BanHangThoiTrangMVC.Models.EF_FirstDB
{
    ...
    public partial class BanHangThoiTrangMVCEntity : DbContext
    {
        public BanHangThoiTrangMVCEntity()
            : base("name=BanHangThoiTrangMVCEntity")
        {
        }
        ...
        public virtual DbSet<tb_SystemSettin> tb_SystemSettin { get; set; }
        public virtual DbSet<tb_Vouchers> tb_Vouchers { get; set; }
